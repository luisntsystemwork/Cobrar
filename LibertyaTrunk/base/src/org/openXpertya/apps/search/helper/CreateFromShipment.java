...
public class CreateFromShipment {
	...
	public static void copyHeaderValuesFromOrder(MInOut inOut, MOrder order, Properties ctx, String trxName) throws ModelException {
	...
	public static void copyLineValuesFromOrderLine(MInOut inOut, MOrder order, MInOutLine inOutLine, MOrderLine orderLine, Properties ctx, String trxName, boolean saveLine) throws ModelException
	{
		// Lines
