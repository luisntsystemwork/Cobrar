...
public class InfoOrderPanel extends InfoPanel implements ValueChangeListener
{
            ...
            boolean multiSelection, String whereClause)
    {
    	...
    	this(WindowNo, value, true, whereClause, true);
    }
            ...
            boolean multiSelection, String whereClause, boolean lookup)
    {
    	...
    	super ( WindowNo, "o", "C_Order_ID", true, whereClause, true);
    ...
    private org.adempiere.webui.component.Button btnInvoice = new org.adempiere.webui.component.Button(); /* Agregado */
    ...
    private void agregarBotonFacturas() {
    	...
    	confirmPanel.addButton(confirmPanel.createButton( "Delete" ));
    	this.btnDelete = confirmPanel.getButton("Delete");
    	this.btnDelete.setEnabled(Boolean.TRUE);
    ...
    public void onEvent(Event event) {
    	...
    	if  (event!=null)
        {
            if (event.getTarget().equals(confirmPanel.getButton("Account")))
            {
                aprobarOT();
            } 
            else if (event.getTarget().equals(confirmPanel.getButton("Delete"))) 
	        {
