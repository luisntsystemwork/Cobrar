...
CERT = "NavCert.crt"        # El certificado X.509 obtenido de Seg. Inf.
PRIVATEKEY = "navicon.key"  # La clave privada del certificado CERT
...
class WSAA(BaseWS):
    ...
    def Autenticar(self, service, crt, key, wsdl=None, proxy=None, wrapper=None, cacert=None, cache=None, debug=False):
        ...
        try:
            ...
            print "Cert y Key: "
            print crt, key, service, wsdl, cacert
