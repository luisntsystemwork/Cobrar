...
public class MLookupFactory {
    ...
    static public MLookupInfo getLookup_TableDirWithCondition(Properties ctx, Language language, int WindowNo, String TableName, String KeyColumn, String valueColumn, String columnCondition, String valueCondition) {
    	String key = "TableDir_"+language.getAD_Language()+"_"+ KeyColumn;
        ...
        realSQL.append(TableName).append(".").append(KeyColumn);
        
        realSQL.append(",NULL,");

        realSQL.append(TableName).append(".").append(valueColumn);
        realSQL.append(",").append(TableName).append(".IsActive");
        ...
        if (CLogMgt.isLevelFinest()) {
            s_log.fine("KeyColumn=" + KeyColumn + " - " + realSQL);
        }
